...
export default function QuickAddWorkoutModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 dark:bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
      <div className="premium-card-static bg-white dark:bg-[var(--color-bg-elevated)] rounded-2xl max-w-md w-full border border-border200 dark:border-[var(--color-border)]/30 shadow-2xl animate-scale-in">
        {/* Header */}
        <div className="flex items-center justify-between p-5 border-b border-border200 dark:border-[var(--color-border)]/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-muted900 dark:text-[var(--color-text-primary)]">הוספת אימון מהירה</h2>
              <p className="text-xs text-muted600 dark:text-[var(--color-text-muted)]">
        ...
        <div className="p-5 space-y-5">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full p-3 bg-white dark:bg-[var(--color-bg-elevated)] border border-border200 dark:border-[var(--color-border)]/30 rounded-xl text-muted900 dark:text-[var(--color-text-primary)] focus:border-emerald-500/50 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 transition-all duration-300"
            >
        ...
        {/* Footer */}
        <div className="flex items-center justify-between p-5 border-t border-border200 dark:border-[var(--color-border)]/30">
          <button
            onClick={onClose}
