            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                <button
                  ...
                  className="p-1 hover:bg-surface(--color-bg-surface)] rounded-lg transition-all duration-300"
                >
        ...
        <div className="flex-1 overflow-y-auto p-5">
          {searchingTrainee ? (
            ...
            <div className="text-center py-12">
              <div className="mx-auto w-16 h-16 bg-gradient-to-br from-amber-100 to-orange-100 rounded-full flex items-center justify-center mb-4 border border-amber-200">
            ...
            <div className="text-center py-12">
              <div className="mx-auto w-16 h-16 bg-gradient-to-br from-gray-100 to-gray-200(--color-bg-surface)](--color-bg-elevated)] rounded-full flex items-center justify-center mb-4 border border-border border-border30">
            ...
            <div className="space-y-3">
              {workouts.map((workout) => (
                <div
                  key={workout.id}
                  className="flex items-center justify-between p-4 bg-white bg-elevated rounded-xl border border-border border-border30 hover:bg-surface50(--color-bg-surface)] transition-all duration-300 shadow-sm"
                >
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="p-2 bg-gradient-to-br from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 text-blue-600 rounded-lg transition-all duration-300 disabled:opacity-50 border border-blue-200"
                      title="שינוי תאריך"
                    >
            ...
            <div className="space-y-4">
              <div className="p-4 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl">
                <h3 className="font-medium text-blue-700 mb-2">שינוי תאריך אימון</h3>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  disabled={!!actionLoading}
                  className="px-6 py-3 bg-surface bg-surface hover:bg-elevated(--color-bg-elevated)] rounded-xl text-foreground text-foreground transition-all duration-300 border border-border border-border30"
                >
                  ביטול
                </button>
              </div>
