          ...
          {step === 'review' && error && (
            <div className="flex flex-col items-center justify-center py-12 gap-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-surface bg-surface hover:bg-elevated(--color-bg-elevated)] text-foreground text-foreground rounded-xl transition-all duration-300 border border-border border-border30"
              >
                נסה שוב
              </button>
            </div>
          ...
          {step === 'review' && !error && matchedEvents.length > 0 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                <div className="bg-gradient-to-br from-gray-50 to-gray-100(--color-bg-surface)](--color-bg-elevated)] border border-border border-border30 rounded-xl p-3 text-center transition-all duration-300 shadow-sm">
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-between p-4 hover:bg-surface(--color-bg-elevated)] transition-all duration-300"
                      >
                        <div className="flex items-center gap-3">
                                ...
                                <button
                                  ...
                                  className={`w-full flex items-center justify-between p-3 rounded-xl transition-all duration-300 ${
                                    decision?.traineeId === match.trainee.id
                                      ...
                                      : 'bg-white bg-elevated hover:bg-surface(--color-bg-surface)] border border-border border-border30'
                                  }`}
                                >
                                  <div className="flex items-center gap-3">
                                ...
                                <button
                                  ...
                                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-xl transition-all duration-300 text-sm ${
                                    decision?.action === 'create'
                                      ...
                                      : 'bg-surface bg-surface hover:bg-elevated(--color-bg-elevated)] text-foreground text-foreground border border-border border-border30'
                                  }`}
                                >
                                  <UserPlus className="h-4 w-4" />
                                  טופס מלא
                              ...
                              <button
                                ...
                                className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-xl transition-all duration-300 text-sm ${
                                  decision?.action === 'skip'
                                    ...
                                    : 'bg-surface bg-surface hover:bg-elevated(--color-bg-elevated)] text-muted text-muted border border-border border-border30'
                                }`}
                              >
                                דלג
                              </button>
