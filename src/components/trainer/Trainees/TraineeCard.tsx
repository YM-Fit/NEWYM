import { Calendar, Phone, TrendingDown, TrendingUp, User, Users, Scale } from 'lucide-react';
...
export default function TraineeCard({ trainee, onClick, unseenWeightsCount = 0 }: TraineeCardProps) {
