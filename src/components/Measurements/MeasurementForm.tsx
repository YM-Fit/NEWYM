...
export default function MeasurementForm({ trainee, onBack, onSave, previousMeasurement, editingMeasurement }: MeasurementFormProps) {
  ...
  const handleSubmit = async () => {
    ...
    const measurementData = {
      ...
      chest: formData.measurements.chestBack || null,
      waist: formData.measurements.belly || null,
      hips: formData.measurements.glutes || null,
      right_thigh: formData.measurements.thigh || null,
