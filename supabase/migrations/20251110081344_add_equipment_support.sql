...
BEGIN
  FOR trainer_record IN SELECT id FROM trainers LOOP
    ...
    INSERT INTO equipment (trainer_id, name, category, emoji, weight_kg, resistance_level, color, is_bodyweight) VALUES
      (trainer_record.id, 'חבל', 'pulley_attachment', '🪢', NULL, NULL, NULL, false),
      (trainer_record.id, 'מוט קצר לפולי', 'pulley_attachment', '━', NULL, NULL, NULL, false),
      (trainer_record.id, 'מוט ארוך לפולי', 'pulley_attachment', '━━', NULL, NULL, NULL, false),
      (trainer_record.id, 'משולש', 'pulley_attachment', '▼', NULL, NULL, NULL, false),
      (trainer_record.id, 'משולש משיכה רחב', 'pulley_attachment', '▼', NULL, NULL, NULL, false),
      (trainer_record.id, 'מוט איחוד', 'pulley_attachment', '┃', NULL, NULL, NULL, false),
      (trainer_record.id, 'ידיות', 'pulley_attachment', '🤲', NULL, NULL, NULL, false),
      (trainer_record.id, 'חובק קרסול', 'pulley_attachment', '⭕', NULL, NULL, NULL, false);
  END LOOP;
END $$;
