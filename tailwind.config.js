    ...
    extend: {
      colors: {
        ...
        surface: {
          ...
          dark: 'rgb(var(--color-bg-surface-dark) / <alpha-value>)',
        ...
        card: {
          ...
          hover: 'rgb(var(--color-bg-card-hover) / <alpha-value>)',
        },
        input: {
          DEFAULT: 'rgb(var(--color-bg-input) / <alpha-value>)',
        ...
        'accent-bg': {
          ...
          hover: 'rgb(var(--color-accent-bg-hover) / <alpha-value>)',
